#define dictionaries
allAboutSports_list = ['arizona cardinals', 'chicago red stars', 'houston rockets', 'indiana fever', 'kentucky derby', 'line coach', 'pair skating', 'penalty shot', 'round-off', 'taekwondo', 'technical foul', 'toronto blue jays', 'triathlete','triple play']
animal_list =['american bison', 'arctic wolf', 'bearded dragon', 'bengal tiger', 'elephant seal', 'ground squirrel', 'guinea pigs', 'prairie dog', 'siberian husky', 'tyrannosaurus rex']
...
dessertsAndSweets_list = ['angel food cake', 'chocolate tard', 'coconut custard', 'pineapple cake']
...
famousBrands_list= ['animal planet', 'enterprise rent-a-car', "lay's chips", 'lego group', 'netflix', 'rockstar energy drink', 'tupperware',]
famousPeople_list = ['dolly parton', 'hippocrates', 'jim morrison', 'kendrick lamar', 'louis armstrong', 'robert frost', 'steve jobs']
...
figuresOfSpeech_list = ['fish out of water', 'go out on a limb', 'heartthrob', 'out of the blue', 'peace of mind']
...
nature_list = ['avalanche', 'coniferous forest', 'gardener', 'grapevine', 'timberland']
...
places_list = ['amazon warehouse', 'caucasus mountains', 'chiropractic clinic', 'community center', 'coney island', 'connecticut', 'dance hall', 'daycare center', 'department store', 'des moines','district court', 'flower shop', 'french quarter', 'georgia', "knott's berry farm", 'lake ontario' 'library of congress', 'madagascar', 'movie theater', 'ranger station', 'solar power plant', 'stonehenge', 'st. petersburg', 'trinidad and tobago', 'wedding hall']
